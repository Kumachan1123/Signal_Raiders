...
void DeviceResources::CreateDeviceResources()
{
	...
	// Initialize the Direct3D 11 API device object and a corresponding context.
	...
	if (FAILED(hr))
	{
		...
		hr = D3D11CreateDevice(
			nullptr,
			D3D_DRIVER_TYPE_WARP, // Initialize a WARP device instead of a hardware device.
			nullptr,
			creationFlags,
			s_featureLevels,
			featLevelCount,
...
void DeviceResources::CreateWindowSizeDependentResources()
{
	...
	{
		// Initialize a descriptor for the swap chain.
		...
		// Initialize a SwapChain from a Win32 window.
	...
	// Initialize a render target view of the swap chain back buffer.
	...
	{
		// Initialize a depth stencil view for use with 3D rendering if needed.
