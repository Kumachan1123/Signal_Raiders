...
const Vector3 EnemyParameters::BOSS_HEAD_OFFSET{ 0.0f, 2.3f, 3.0f };// ボスの頭の砲口のオフセット

const Vector3 EnemyParameters::BOSS_LEFT_GUN_OFFSET{ -2.5f,0.80f, 3.0f };// 上の座標

const Vector3 EnemyParameters::BOSS_RIGHT_GUN_OFFSET{ 2.5f, 0.80f, 3.0f };// 右の座標
