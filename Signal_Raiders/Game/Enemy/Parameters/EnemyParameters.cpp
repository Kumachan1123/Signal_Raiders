...
const float EnemyParameters::SPECIAL_ATTACK_COOLDOWN = 30.0f;// 特殊攻撃のクールダウンタイム
...
const Vector3 EnemyParameters::INITIAL_BOSS_SCALE{ 1.0f,1.0f,1.0f };// ボスの初期スケール

const Vector3 EnemyParameters::BOSS_SPHERE_OFFSET{ 0.0f,0.5f,0.0f };// ボスの境界球のオフセット

const Vector3 EnemyParameters::BOSS_HEAD_OFFSET{ 0.0f, 2.0f, 3.0f };// ボスの頭の砲口のオフセット

const Vector3 EnemyParameters::BOSS_LEFT_GUN_OFFSET{ -2.5f,-0.50f, 3.0f };// 上の座標

const Vector3 EnemyParameters::BOSS_RIGHT_GUN_OFFSET{ 2.5f, -0.50f, 3.0f };// 右の座標
