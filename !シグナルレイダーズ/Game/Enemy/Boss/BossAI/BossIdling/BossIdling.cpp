...
void BossIdling::Update(float elapsedTime, DirectX::SimpleMath::Vector3& pos, DirectX::SimpleMath::Vector3& playerPos, bool isHitToPlayer)
{
	...
	float randomMultiplier = m_pBoss->GenerateRandomMultiplier(RANDOM_MIN, RANDOM_MAX);  // ランダムな倍率を生成
	...
	float moveCorrect = m_pBoss->GenerateRandomMultiplier(10.0f, 10.0f);
