...
const std::vector<D3D11_INPUT_ELEMENT_DESC> StageSelectUI::INPUT_LAYOUT =
{
...
void StageSelectUI::LoadTexture(const wchar_t* path)
{
	//	指定された画像を読み込む
...
void StageSelectUI::Create(DX::DeviceResources* pDR, const wchar_t* path
...
void StageSelectUI::CreateShader()
{
...
void StageSelectUI::Update(float elapsedTime)
{
	m_time += elapsedTime;
...
void StageSelectUI::SetWindowSize(const int& width, const int& height)
{
	m_windowWidth = width;
